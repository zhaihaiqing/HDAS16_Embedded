 ...
 * @sa getCIDR()
 */
#define W6100_CIDR               (_W6100_IO_BASE_ + (0x0000 << 8) + WIZCHIP_CREG_BLOCK)

/**
 * @brief Chip Version Register address [RO] [0x4661]
 * @sa getVER()
 */
#define W6100_VER                (_W6100_IO_BASE_ + (0x0002 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SYSR             (_W6100_IO_BASE_ + (0x2000 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SYCR0              (_W6100_IO_BASE_ + (0x2004 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SYCR1              (WIZCHIP_OFFSET_INC( W6100_SYCR0,1))
 ...
 */
#define W6100_TCNTR             (_W6100_IO_BASE_ + (0x2016 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_TCNTRCLR          (_W6100_IO_BASE_ + (0x2020 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_IR                 (_W6100_IO_BASE_ + (0x2100 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SIR               (_W6100_IO_BASE_ + (0x2101 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 *     getSYCR1(), setSYCR1(), getCHPLCKR(), setCHPLCKR(), CHIPLOCK(), CHIPUNLOCK(), getSYSR()
 */
#define W6100_SLIR              (_W6100_IO_BASE_ + (0x2102 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 *     getSYCR1(), setSYCR1(), getCHPLCKR(), setCHPLCKR(), CHIPLOCK(), CHIPUNLOCK(), getSYSR()
 */
#define W6100_IMR               (_W6100_IO_BASE_ + (0x2104 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_IRCLR              (_W6100_IO_BASE_ + (0x2108 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 *     getSYCR1(), setSYCR1(), getCHPLCKR(), setCHPLCKR(), CHIPLOCK(), CHIPUNLOCK(), getSYSR()
 */
#define W6100_SIMR              (_W6100_IO_BASE_ + (0x2114 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 *     getSYCR1(), setSYCR1(), getCHPLCKR(), setCHPLCKR(), CHIPLOCK(), CHIPUNLOCK(), getSYSR()
 */
#define W6100_SLIMR              (_W6100_IO_BASE_ + (0x2124 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 *     getSYCR1(), setSYCR1(), getCHPLCKR(), setCHPLCKR(), CHIPLOCK(), CHIPUNLOCK(), getSYSR()
 */
#define W6100_SLIRCLR            (_W6100_IO_BASE_ + (0x2128 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SLPSR             (_W6100_IO_BASE_ + (0x212C << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SLCR              (_W6100_IO_BASE_ + (0x2130 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYSR             (_W6100_IO_BASE_ + (0x3000 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYRAR            (_W6100_IO_BASE_ + (0x3008 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYDIR             (_W6100_IO_BASE_ + (0x300C << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYDOR             (_W6100_IO_BASE_ + (0x3010 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYACR             (_W6100_IO_BASE_ + (0x3014 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYDIVR            (_W6100_IO_BASE_ + (0x3018 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYCR0             (_W6100_IO_BASE_ + (0x301C << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYCR1            WIZCHIP_OFFSET_INC(W6100_PHYCR0,1)
 ...
 */
#define W6100_NET4MR             (_W6100_IO_BASE_ + (0x4000 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_NET6MR            (_W6100_IO_BASE_ + (0x4004 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 *
 */
#define W6100_NETMR              (_W6100_IO_BASE_ + (0x4008 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_NETMR2             (_W6100_IO_BASE_ + (0x4009 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PTMR               (_W6100_IO_BASE_ + (0x4100 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PMNR_               (_W6100_IO_BASE_ + (0x4104 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHAR               (_W6100_IO_BASE_ + (0x4108 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PSIDR              (_W6100_IO_BASE_ + (0x4110 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PMRUR             (_W6100_IO_BASE_ + (0x4114 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SHAR               (_W6100_IO_BASE_ + (0x4120 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_GAR                (_W6100_IO_BASE_ + (0x4130 << 8) + WIZCHIP_CREG_BLOCK)
#define W6100_GA4R               (W6100_GAR)      ///< Refer to @ref _GAR_
/**
 ...
 */
#define W6100_SUBR              (_W6100_IO_BASE_ + (0x4134 << 8) + WIZCHIP_CREG_BLOCK)
#define W6100_SUB4R             (W6100_SUBR)      ///< Refer to @ref _SUBR_
 ...
 */
#define W6100_SIPR              (_W6100_IO_BASE_ + (0x4138 << 8) + WIZCHIP_CREG_BLOCK)
#define W6100_SIP4R             (W6100_SIPR)   ///< Refer to @ref _SIPR_.
 ...
 */
#define W6100_LLAR               (_W6100_IO_BASE_ + (0x4140 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_GUAR              (_W6100_IO_BASE_ + (0x4150 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SUB6R              (_W6100_IO_BASE_ + (0x4160 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_GA6R               (_W6100_IO_BASE_ + (0x4170 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SLDIP6R            (_W6100_IO_BASE_ + (0x4180 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SLDIPR            (_W6100_IO_BASE_ + (0x418C << 8) + WIZCHIP_CREG_BLOCK)
#define W6100_SLDIP4R            (W6100_SLDIPR)            ///< Refer to @ref _SLDIPR_.
 ...
 *     getSLIR(), setSLIRCLR(), getSLIMR(), setSLIMR() 
 */
#define W6100_SLDHAR             (_W6100_IO_BASE_ + (0x4190 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PINGIDR          (_W6100_IO_BASE_ + (0x4198 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PINGSEQR           (_W6100_IO_BASE_ + (0x419C << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_UIPR               (_W6100_IO_BASE_ + (0x41A0 << 8) + WIZCHIP_CREG_BLOCK)
#define W6100_UIP4R              (W6100_UIPR)   ///< Refer to @ref _UPORTR_
 ...
 */
#define W6100_UPORTR            (_W6100_IO_BASE_ + (0x41A4 << 8) + WIZCHIP_CREG_BLOCK)
#define W6100_UPORT4R            (W6100_UPORTR)   ///< Refer to @ref _UPORTR_
/**
 ...
 */
#define W6100_UIP6R             (_W6100_IO_BASE_ + (0x41B0 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 * @sa getUIPR6(), setUIPR6(), getUIPR(), setUIPR(), getUPORTR(), setUPORTR(), getUPORT6R(), setUPORT6R()
 */
#define W6100_UPORT6R            (_W6100_IO_BASE_ + (0x41C0 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_INTPTMR            (_W6100_IO_BASE_ + (0x41C5 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PLR               (_W6100_IO_BASE_ + (0x41D0 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PFR               (_W6100_IO_BASE_ + (0x41D4 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_VLTR              (_W6100_IO_BASE_ + (0x41D8 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PLTR               (_W6100_IO_BASE_ + (0x41DC << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PAR               (_W6100_IO_BASE_ + (0x41E0 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_ICMP6BLKR         (_W6100_IO_BASE_ + (0x41F0 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_CHPLCKR           (_W6100_IO_BASE_ + (0x41F4 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_NETLCKR            (_W6100_IO_BASE_ + (0x41F5 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_PHYLCKR            (_W6100_IO_BASE_ + (0x41F6 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_RTR                (_W6100_IO_BASE_ + (0x4200 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 *     getSn_CR(), getSn_CR(), getSn_IR(), setSn_IRCLR()
 */
#define W6100_RCR               (_W6100_IO_BASE_ + (0x4204 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SLRTR              (_W6100_IO_BASE_ + (0x4208 << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SLRCR             (_W6100_IO_BASE_ + (0x420C << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_SLHOPR             (_W6100_IO_BASE_ + (0x420F << 8) + WIZCHIP_CREG_BLOCK)
 ...
 */
#define W6100_Sn_MR_(N)           (_W6100_IO_BASE_ + (0x0000 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
 #define W6100_Sn_PSR_(N)         (_W6100_IO_BASE_ + (0x0004 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_CR_(N)           (_W6100_IO_BASE_ + (0x0010 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_IR_(N)           (_W6100_IO_BASE_ + (0x0020 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_IMR_(N)          (_W6100_IO_BASE_ + (0x0024 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_IRCLR_(N)        (_W6100_IO_BASE_ + (0x0028 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 *
 */
#define W6100_Sn_SR_(N)           (_W6100_IO_BASE_ + (0x0030 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_ESR_(N)          (_W6100_IO_BASE_ + (0x0031 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_PNR_(N)          (_W6100_IO_BASE_ + (0x0100 << 8) + WIZCHIP_SREG_BLOCK(N))
#define W6100_Sn_NHR_(N)          (W6100_Sn_PNR_(N))      ///< Refer to @ref _Sn_PNR_.
 ...
 */
#define W6100_Sn_TOSR_(N)         (_W6100_IO_BASE_ + (0x0104 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_TTLR_(N)         (_W6100_IO_BASE_ + (0x0108 << 8) + WIZCHIP_SREG_BLOCK(N))
#define W6100_Sn_HOPR_(N)         (W6100_Sn_TTLR_(N))   ///< Refer to @ref _Sn_TTLR_.
 ...
 */
#define W6100_Sn_FRGR_(N)         (_W6100_IO_BASE_ + (0x010C << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_MSSR_(N)         (_W6100_IO_BASE_ + (0x0110 << 8) + WIZCHIP_SREG_BLOCK(N))
...
*/
#define W6100_Sn_PORTR_(N)        (_W6100_IO_BASE_ + (0x0114 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_DHAR_(N)         (_W6100_IO_BASE_ + (0x0118 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_DIPR_(N)         (_W6100_IO_BASE_ + (0x0120 << 8) + WIZCHIP_SREG_BLOCK(N))
#define W6100_Sn_DIP4R_(N)        (W6100_Sn_DIPR_(N))            ///< Refer to @ref _Sn_DIPR_.
 ...
 */
#define W6100_Sn_DIP6R_(N)        (_W6100_IO_BASE_ + (0x0130 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_DPORTR_(N)       (_W6100_IO_BASE_ + (0x0140 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_MR2_(N)          (_W6100_IO_BASE_ + (0x0144 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_RTR_(N)          (_W6100_IO_BASE_ + (0x0180 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 * @sa getSn_RTR(), setSn_RTR(), getSn_CR(), setSn_CR()
 */
#define W6100_Sn_RCR_(N)          (_W6100_IO_BASE_ + (0x0184 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_KPALVTR_(N)      (_W6100_IO_BASE_ + (0x0188 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_TX_BSR_(N)       (_W6100_IO_BASE_ + (0x0200 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_TX_FSR_(N)       (_W6100_IO_BASE_ + (0x0204 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_TX_RD_(N)        (_W6100_IO_BASE_ + (0x0208 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_TX_WR_(N)        (_W6100_IO_BASE_ + (0x020C << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_RX_BSR_(N)       (_W6100_IO_BASE_ + (0x0220 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_RX_RSR_(N)       (_W6100_IO_BASE_ + (0x0224 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define W6100_Sn_RX_RD_(N)        (_W6100_IO_BASE_ + (0x0228 << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 * @sa getSn_TX_WR(), setSn_TX_WR(), getSn_TX_RD(), getSn_TX_FSR(), getSn_CR(), setSn_CR(), getSn_IR(), setSn_IRCLR(), getSn_MR(), setSn_MR()
 */
#define W6100_Sn_RX_WR_(N)        (_W6100_IO_BASE_ + (0x022C << 8) + WIZCHIP_SREG_BLOCK(N))
 ...
 */
#define getCIDR() \
        ((((uint16_t)WIZCHIP_READ(W6100_CIDR)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_CIDR,1)))

#define getVER() \
        ((((uint16_t)WIZCHIP_READ(W6100_VER)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_VER,1)))

#define getSYSR() \
        WIZCHIP_READ(W6100_SYSR)

#define getSYCR0() \
        WIZCHIP_READ(W6100_SYCR0)

#define setSYCR0(sycr0) \
        WIZCHIP_WRITE(W6100_SYCR0, (sycr0))

#define getSYCR1() \
        WIZCHIP_READ(W6100_SYCR1)
                  
#define setSYCR1(sycr1) \
        WIZCHIP_WRITE(W6100_SYCR1, (sycr1))

#define getTCNTR() \
        ((((uint16_t)WIZCHIP_READ(W6100_TCNTR)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_TCNTR,1)))

#define setTCNTRCLR(tcntrclr) \
        WIZCHIP_WRITE(W6100_TCNTRCLR,(tcntrclr))

#define getIR() \
        WIZCHIP_READ(W6100_IR)

#define getSIR() \
        WIZCHIP_READ(W6100_SIR)

#define getSLIR() \
        WIZCHIP_READ(W6100_SLIR)

#define setIMR(imr) \
        WIZCHIP_WRITE(W6100_IMR,(imr))

#define getIMR() \
        WIZCHIP_READ(W6100_IMR)

#define setIRCLR(irclr) \
        WIZCHIP_WRITE(W6100_IRCLR,(irclr))
#define setIR(ir)                setIRCLR(ir)

#define setSIMR(simr) \
        WIZCHIP_WRITE(W6100_SIMR,(simr))

#define getSIMR() \
        WIZCHIP_READ(W6100_SIMR)

#define setSLIMR(slimr) \
        WIZCHIP_WRITE(W6100_SLIMR,(slimr))

#define getSLIMR() \
        WIZCHIP_READ(W6100_SLIMR)

#define setSLIRCLR(slirclr) \
        WIZCHIP_WRITE(W6100_SLIRCLR,(slirclr))
#define setSLIR(slir)            setSLIRCLR(slir)

#define setSLPSR(slpsr) \
        WIZCHIP_WRITE(W6100_SLPSR,(slpsr))

#define getSLPSR() \
        WIZCHIP_READ(W6100_SLPSR)

#define setSLCR(slcr) \
        WIZCHIP_WRITE(W6100_SLCR,(slcr))
                  
#define getSLCR()      \
        WIZCHIP_READ(W6100_SLCR)

#define getPHYSR() \
        WIZCHIP_READ(W6100_PHYSR)

#define setPHYRAR(phyrar) \
        WIZCHIP_WRITE(W6100_PHYRAR,(phyrar))

#define getPHYRAR() \
        WIZCHIP_READ(W6100_PHYRAR)

#define setPHYDIR(phydir)  \
        do{                                                                       \
           WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_PHYDIR,1), (uint8_t)((phydir)>>8)); \
           WIZCHIP_WRITE(W6100_PHYDIR, (uint8_t)(phydir));                            \
        }while(0);

#define getPHYDOR() \
        ((((uint16_t)WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_PHYDOR,1))) << 8) + WIZCHIP_READ(W6100_PHYDOR))

#define setPHYACR(phyacr) \
        WIZCHIP_WRITE(W6100_PHYACR,(phyacr))

#define getPHYACR() \
        WIZCHIP_READ(W6100_PHYACR)

#define setPHYDIVR(phydivr) \
        WIZCHIP_WRITE(W6100_PHYDIVR,(phydivr))

#define getPHYDIVR() \
        WIZCHIP_READ(W6100_PHYDIVR)

#define setPHYCR0(phycr0) \
        WIZCHIP_WRITE(W6100_PHYCR0,(phycr0))

#define setPHYCR1(phycr1) \
        WIZCHIP_WRITE(W6100_PHYCR1,(phycr1))

#define getPHYCR1() \
        WIZCHIP_READ(W6100_PHYCR1)

#define setNET4MR(net4mr) \
        WIZCHIP_WRITE(W6100_NET4MR,(net4mr))

#define setNET6MR(net6mr) \
        WIZCHIP_WRITE(W6100_NET6MR,(net6mr))

#define setNETMR(netmr) \
        WIZCHIP_WRITE(W6100_NETMR,(netmr))

#define setNETMR2(netmr2) \
        WIZCHIP_WRITE(W6100_NETMR2,(netmr2))

#define getNET4MR() \
        WIZCHIP_READ(W6100_NET4MR)

#define getNET6MR() \
        WIZCHIP_READ(W6100_NET6MR)

#define getNETMR() \
        WIZCHIP_READ(W6100_NETMR)

#define getNETMR2() \
        WIZCHIP_READ(W6100_NETMR2)

#define setPTMR(ptmr) \
        WIZCHIP_WRITE(W6100_PTMR, (ptmr))

#define getPTMR() \
        WIZCHIP_READ(W6100_PTMR)

#define setPMNR(pmnr) \
        WIZCHIP_WRITE(W6100_PMNR, (pmnr))

#define getPMNR() \
        WIZCHIP_READ(W6100_PMNR)

#define setPHAR(phar) \
        WIZCHIP_WRITE_BUF(W6100_PHAR,(phar),6)

#define getPHAR(phar) \
        WIZCHIP_READ_BUF(W6100_PHAR,(phar),6)

#define setPSIDR(psidr) \
        do{                                                                \
            WIZCHIP_WRITE(W6100_PSIDR,(uint8_t)((psidr) >> 8));                \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_PSIDR,1),(uint8_t)(psidr)); \
        }while(0);

#define getPSIDR() \
        ((((uint16_t)WIZCHIP_READ(W6100_PSIDR)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_PSIDR,1)))

#define setPMRUR(pmrur) \
        do{                                                                \
            WIZCHIP_WRITE(W6100_PMRUR_,(uint8_t)((pmrur) >> 8));                \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_PMRUR,1),(uint8_t)(pmrur)); \
        }while(0);

#define getPMRUR() \
        ((((uint16_t)WIZCHIP_READ(W6100_PMRUR)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_PMRUR,1)))

#define setSHAR(shar) \
        WIZCHIP_WRITE_BUF(W6100_SHAR,(shar),6)

#define getSHAR(shar) \
        WIZCHIP_READ_BUF(W6100_SHAR,(shar),6)

#define setGAR(gar) \
        WIZCHIP_WRITE_BUF(W6100_GAR,(gar),4)

#define getGAR(gar) \
        WIZCHIP_READ_BUF(W6100_GAR,(gar),4)

#define setGA4R(ga4r)            setGAR(ga4r)
#define getGA4R(ga4r)            getGAR(ga4r)

#define setSUBR(subr) \
        WIZCHIP_WRITE_BUF(W6100_SUBR,(subr),4)

#define getSUBR(subr) \
        WIZCHIP_READ_BUF(W6100_SUBR,(subr),4)

#define setSUB4R(sub4r)          setSUBR(sub4r)
#define getSUB4R(sub4r)          getSUBR(sub4r)

#define setSIPR(sipr) \
        WIZCHIP_WRITE_BUF(W6100_SIPR,(sipr),4)

#define getSIPR(sipr) \
        WIZCHIP_READ_BUF(W6100_SIPR,(sipr),4)

#define setLLAR(llar) \
        WIZCHIP_WRITE_BUF(W6100_LLAR,(llar),16)

#define getLLAR(llar) \
        WIZCHIP_READ_BUF(W6100_LLAR,(llar),16)

#define setGUAR(guar) \
        WIZCHIP_WRITE_BUF(W6100_GUAR,(guar),16)

#define getGUAR(guar) \
        WIZCHIP_READ_BUF(W6100_GUAR,(guar),16)

#define setSUB6R(sub6r) \
        WIZCHIP_WRITE_BUF(W6100_SUB6R,(sub6r),16)

#define getSUB6R(sub6r) \
        WIZCHIP_READ_BUF(W6100_SUB6R,(sub6r),16)

#define setGA6R(ga6r) \
        WIZCHIP_WRITE_BUF(W6100_GA6R,(ga6r),16)

#define getGA6R(ga6r) \
        WIZCHIP_READ_BUF(W6100_GA6R,(ga6r),16)

#define setSLDIPR(sldipr) \
        WIZCHIP_WRITE_BUF(W6100_SLDIPR,(sldipr),4)
#define setSLDIP4R(sldip4r)      setSLDIPR((sldip4r))

#define getSLDIPR(sldipr) \
        WIZCHIP_READ_BUF(W6100_SLDIPR,(sldipr),4)
#define getSLDIP4R(sldip4r)      getSLDIPR((sldip4r))

#define setSLDIP6R(sldip6r) \
        WIZCHIP_WRITE_BUF(W6100_SLDIP6R, (sldip6r),16)

#define getSLDIP6R(sldip6r) \
        WIZCHIP_READ_BUF(W6100_SLDIP6R,(sldip6r),16)

#define getSLDHAR(sldhar) \
        WIZCHIP_READ_BUF(W6100_SLDHAR,(sldhar),6)

#define setPINGIDR(pingidr) \
        do{                                                                    \
            WIZCHIP_WRITE(W6100_PINGIDR,(uint8_t)((pingidr)>>8));                  \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_PINGIDR,1),(uint8_t)(pingidr)); \
        }while(0);

#define getPINGIDR() \
        (((int16_t)(WIZCHIP_READ(W6100_PINGIDR) << 8)) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_PINGIDR,1)))

#define setPINGSEQR(pingseqr) \
        do{                                                                      \
            WIZCHIP_WRITE(W6100_PINGSEQR,(uint8_t)((pingseqr)>>8));                  \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_PINGSEQR,1),(uint8_t)(pingseqr)); \
        }while(0);

#define getPINGSEQR() \
        (((int16_t)(WIZCHIP_READ(W6100_PINGSEQR) << 8)) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_PINGSEQR,1)))

#define getUIPR(uipr) \
        WIZCHIP_READ_BUF(W6100_UIPR, (uipr), 4)

#define getUIP4R(uip4r)          getUIPR(uip4r)

#define getUPORTR() \
        ((((uint16_t)WIZCHIP_READ(W6100_UPORTR)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_UPORTR,1)))

#define getUPORT4R()             getUPORTR()

#define getUIP6R(uip6r) \
        WIZCHIP_READ_BUF(W6100_UIP6R,(uip6r),16)

#define getUPORT6R(uport6r) \
        ((((uint16_t)WIZCHIP_READ(W6100_UPORT6R)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_UPORT6R,1)))

#define setINTPTMR(intptmr) \
        do{                                                                     \
            WIZCHIP_WRITE(W6100_INTPTMR,(uint8_t)((intptmr) >> 8));                 \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_INTPTMR,1),(uint8_t)(intptmr));  \
       }while(0);

#define getINTPTMR() \
        ((((uint16_t)WIZCHIP_READ(W6100_INTPTMR)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_INTPTMR,1)))

#define getPLR() \
        WIZCHIP_READ(W6100_PLR)

#define getPFR() \
        WIZCHIP_READ(W6100_PFR)

#define getVLTR() \
        ( (((uint32_t)WIZCHIP_READ(W6100_VLTR)) << 24) +                       \
          (((uint32_t)WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_VLTR,1))) << 16) + \
          (((uint32_t)WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_VLTR,2))) << 16) + \
          (((uint32_t)WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_VLTR,3))) << 16) )

#define getPLTR() \
        ( (((uint32_t)WIZCHIP_READ(W6100_PLTR)) << 24) +                       \
          (((uint32_t)WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_PLTR,1))) << 16) + \
          (((uint32_t)WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_PLTR,2))) << 16) + \
          (((uint32_t)WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_PLTR,3))) << 16) )

#define getPAR(par) \
        WIZCHIP_READ_BUF(W6100_PAR, (par), 16)

#define setICMP6BLKR(icmp6blkr) \
        WIZCHIP_WRITE(W6100_ICMP6BLKR,(icmp6blkr))

#define getICMP6BLKR() \
        WIZCHIP_READ(W6100_ICMP6BLKR)

#define setCHPLCKR(chplckr) \
        WIZCHIP_WRITE(W6100_CHPLCKR, (chplckr))
...
#define setNETLCKR(netlckr) \
        WIZCHIP_WRITE(W6100_NETLCKR, (netlckr))
...
#define setPHYLCKR(phylckr) \
        WIZCHIP_WRITE(W6100_PHYLCKR,(phylckr))
...
#define setRTR(rtr) \
        do{                                                            \
            WIZCHIP_WRITE(W6100_RTR,(uint8_t)((rtr)>>8));                  \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_RTR,1),(uint8_t)(rtr)); \
        }while(0);

#define getRTR() \
        ((((uint16_t)WIZCHIP_READ(W6100_RTR)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_RTR,1)))

#define setRCR(rcr) \
        WIZCHIP_WRITE(W6100_RCR,(rcr))

#define getRCR() \
        WIZCHIP_READ(W6100_RCR)

#define setSLRTR(slrtr) \
        do{                                                                \
            WIZCHIP_WRITE(W6100_SLRTR,(uint8_t)((slrtr)>>8));                  \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_SLRTR,1),(uint8_t)(slrtr)); \
        }while(0);

#define getSLRTR() \
        ((((uint16_t)WIZCHIP_READ(W6100_SLRTR)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_SLRTR,1)))

#define setSLRCR(slrcr) \
        WIZCHIP_WRITE(W6100_SLRCR,(slrcr))

#define getSLRCR() \
        WIZCHIP_READ(W6100_SLRCR)

#define setSLHOPR(slhopr) \
        WIZCHIP_WRITE(W6100_SLHOPR,(slhopr))

#define getSLHOPR() \
        WIZCHIP_READ(W6100_SLHOPR)
/**
 * @}
 */
...
#define setSn_MR(sn,mr) \
        WIZCHIP_WRITE(W6100_Sn_MR_(sn),(mr))
#define getSn_MR(sn) \
        WIZCHIP_READ(W6100_Sn_MR_(sn))

#define setSn_PSR(sn,psr) \
        WIZCHIP_WRITE(W6100_Sn_PSR_(sn),(psr))
#define getSn_PSR(sn) \
        WIZCHIP_READ(W6100_Sn_PSR_(sn))

#define setSn_CR(sn,cr) \
        WIZCHIP_WRITE(W6100_Sn_CR_(sn),(cr))
#define getSn_CR(sn) \
        WIZCHIP_READ(W6100_Sn_CR_(sn))

#define getSn_IR(sn) \
        WIZCHIP_READ(W6100_Sn_IR_(sn))

#define setSn_IMR(sn,imr) \
        WIZCHIP_WRITE(W6100_Sn_IMR_(sn),(imr))
#define getSn_IMR(sn) \
        WIZCHIP_READ(W6100_Sn_IMR_(sn))

#define setSn_IRCLR(sn,irclr) \
        WIZCHIP_WRITE(W6100_Sn_IRCLR_(sn),(irclr))
#define setSn_IR(sn,ir)          setSn_IRCLR(sn,(ir))

#define getSn_SR(sn) \
        WIZCHIP_READ(W6100_Sn_SR_(sn))

#define getSn_ESR(sn) \
        WIZCHIP_READ(W6100_Sn_ESR_(sn))

#define setSn_PNR(sn,pnr) \
        WIZCHIP_WRITE(W6100_Sn_PNR_(sn),(pnr))
#define setSn_NHR(sn,nhr)        setSn_PNR(W6100_Sn_PNR_(sn),(nhr))

#define getSn_PNR(sn) \
        WIZCHIP_READ(W6100_Sn_PNR_(sn))
#define getSn_NHR(sn)            getSn_PNR(sn)

#define setSn_TOSR(sn,tosr) \
        WIZCHIP_WRITE(W6100_Sn_TOSR_(sn),(tosr))
#define getSn_TOSR(sn) \
        WIZCHIP_READ(W6100_Sn_TOSR_(sn))

#define setSn_TTLR(sn,ttlr) \
        WIZCHIP_WRITE(W6100_Sn_TTLR_(sn),(ttlr))
#define getSn_TTLR(sn) \
        WIZCHIP_READ(W6100_Sn_TTLR_(sn))
...
#define setSn_FRGR(sn,frgr) \
        do{                                                                      \
            WIZCHIP_WRITE(W6100_Sn_FRGR_(sn),(uint8_t)((frgr)>>8));                   \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_Sn_FRGR_(sn),1),(uint8_t)(frgr));  \
        }while(0);
#define getSn_FRGR(sn,frgr) \
        ((((uint16_t)WIZCHIP_READ(W6100_Sn_FRGR_(sn))) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_FRGR_(sn),1)))

#define setSn_MSSR(sn,mssr) \
        do{                                                                      \
            WIZCHIP_WRITE(W6100_Sn_MSSR_(sn),(uint8_t)((mssr)>>8));                   \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_Sn_MSSR_(sn),1),(uint8_t)(mssr));  \
        }while(0);
#define getSn_MSSR(sn) \
        ((((uint16_t)WIZCHIP_READ(W6100_Sn_MSSR_(sn))) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_MSSR_(sn),1)))

#define setSn_PORTR(sn,portr) \
        do{                                                                       \
            WIZCHIP_WRITE(W6100_Sn_PORTR_(sn),(uint8_t)((portr)>>8));                  \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_Sn_PORTR_(sn),1),(uint8_t)(portr)); \
        }while(0);
#define getSn_PORTR(sn) \
        ((((uint16_t)WIZCHIP_READ(W6100_Sn_PORTR_(sn))) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_PORTR_(sn),1)))

#define setSn_DHAR(sn,dhar) \
        WIZCHIP_WRITE_BUF(W6100_Sn_DHAR_(sn),(dhar),6)
#define getSn_DHAR(sn,dhar) \
        WIZCHIP_READ_BUF(W6100_Sn_DHAR_(sn),(dhar),6)

#define setSn_DIPR(sn,dipr) \
        WIZCHIP_WRITE_BUF(W6100_Sn_DIPR_(sn),(dipr),4)
#define getSn_DIPR(sn,dipr) \
        WIZCHIP_READ_BUF(W6100_Sn_DIPR_(sn),(dipr),4)

#define setSn_DIP4R(sn,dipr)      setSn_DIPR(sn,(dipr))
#define getSn_DIP4R(sn,dipr)      getSn_DIPR(sn,(dipr))

#define setSn_DIP6R(sn,dip6r) \
        WIZCHIP_WRITE_BUF(W6100_Sn_DIP6R_(sn),(dip6r),16)
#define getSn_DIP6R(sn,dip6r) \
        WIZCHIP_READ_BUF(W6100_Sn_DIP6R_(sn),(dip6r),16)

#define setSn_DPORTR(sn,dportr) \
        do{                                                                         \
            WIZCHIP_WRITE(W6100_Sn_DPORTR_(sn),(uint8_t)((dportr)>>8));                  \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_Sn_DPORTR_(sn),1),(uint8_t)(dportr)); \
        }while(0);
#define getSn_DPORTR(sn) \
        ((((uint16_t)WIZCHIP_READ(W6100_Sn_DPORTR_(sn))) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_DPORTR_(sn),1)))

#define setSn_MR2(sn,mr2) \
        WIZCHIP_WRITE(W6100_Sn_MR2_(sn),(mr2))
#define getSn_MR2(sn) \
        WIZCHIP_READ(W6100_Sn_MR2_(sn))

#define setSn_RTR(sn,rtr) \
        do{                                                                   \
            WIZCHIP_WRITE(W6100_Sn_RTR_(sn),(uint8_t)((rtr)>>8));                  \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_Sn_RTR_(sn),1),(uint8_t)(rtr)); \
        }while(0);
#define getSn_RTR(sn) \
        ((((uint16_t)WIZCHIP_READ(W6100_Sn_RTR_(sn))) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_RTR_(sn),1)))

#define setSn_RCR(sn,rcr) \
        WIZCHIP_WRITE(W6100_Sn_RCR_(sn),(rcr))
#define getSn_RCR(sn) \
        WIZCHIP_READ(W6100_Sn_RCR_(sn))

#define setSn_KPALVTR(sn,kpalvtr) \
        WIZCHIP_WRITE(W6100_Sn_KPALVTR_(sn),(kpalvtr))
#define getSn_KPALVTR(sn) \
        WIZCHIP_READ(W6100_Sn_KPALVTR_(sn))

#define setSn_TX_BSR(sn, tmsr) \
        WIZCHIP_WRITE(W6100_Sn_TX_BSR_(sn),(tmsr))
#define setSn_TXBUF_SIZE(sn, tmsr)      setSn_TX_BSR(sn,(tmsr))

#define getSn_TX_BSR(sn) \
        WIZCHIP_READ(W6100_Sn_TX_BSR_(sn))
...
#define getSn_TX_RD(sn) \
        ((((uint16_t)WIZCHIP_READ(W6100_Sn_TX_RD_(sn))) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_TX_RD_(sn),1)))

#define setSn_TX_WR(sn,txwr) \
        do{                                                                       \
            WIZCHIP_WRITE(W6100_Sn_TX_WR_(sn), (uint8_t)((txwr)>>8));                  \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_Sn_TX_WR_(sn),1), (uint8_t)(txwr)); \
        }while(0);
#define getSn_TX_WR(sn) \
        (((uint16_t)WIZCHIP_READ(W6100_Sn_TX_WR_(sn)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_TX_WR_(sn),1)))

#define setSn_RX_BSR(sn,rmsr) \
        WIZCHIP_WRITE(W6100_Sn_RX_BSR_(sn),(rmsr))
#define setSn_RXBUF_SIZE(sn,rmsr)      setSn_RX_BSR(sn,(rmsr))

#define getSn_RX_BSR(sn) \
        WIZCHIP_READ(W6100_Sn_RX_BSR_(sn))
...
#define setSn_RX_RD(sn,rxrd) \
        do{                                                                        \
            WIZCHIP_WRITE(W6100_Sn_RX_RD_(sn), (uint8_t)((rxrd)>>8));                   \
            WIZCHIP_WRITE(WIZCHIP_OFFSET_INC(W6100_Sn_RX_RD_(sn),1), (uint8_t)(rxrd)) ; \
        }while(0);

#define getSn_RX_RD(sn) \
        (((uint16_t)WIZCHIP_READ(W6100_Sn_RX_RD_(sn)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_RX_RD_(sn),1)))

#define getSn_RX_WR(sn) \
        (((uint16_t)WIZCHIP_READ(W6100_Sn_RX_WR_(sn)) << 8) + WIZCHIP_READ(WIZCHIP_OFFSET_INC(W6100_Sn_RX_WR_(sn),1)))
/**
 * @}
 */
